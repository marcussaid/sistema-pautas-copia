...
def test_upload_valid_file(monkeypatch, client):
    ...
    response = client.post(f'/upload_anexo/{registro_id}', data=data, content_type='multipart/form-data')
...
def test_upload_no_file(client):
    ...
    response = client.post(f'/upload_anexo/{registro_id}', data={}, content_type='multipart/form-data')
    json_data = json.loads(response.data)
...
# Additional tests could be added to verify database updates, error handling, etc.
